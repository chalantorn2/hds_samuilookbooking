-- =====================================================
-- Migration: Add ticket_type_details to Report View
-- Description:
--   เพิ่ม field ticket_type_details เพื่อใช้ group by ใน report
--   สำหรับ Ticket Type: TG, B2B, OTHER
-- Date: 2026-02-06
-- =====================================================
...
--    - เพิ่ม ticket_type_details field
-- =====================================================
...
SELECT
    ...
    COALESCE((SELECT `ticket_type_details` FROM `ticket_additional_info` WHERE `bookings_ticket_id` = `bt`.`id` LIMIT 1), '') AS `ticket_type_details`,
...
--    - เพิ่ม ticket_type_details (empty string เพราะไม่มี)
-- =====================================================
